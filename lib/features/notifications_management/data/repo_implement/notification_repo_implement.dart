...
class NotificationRepoImplement extends NotificationRepo {
  ...
  Future<Either<Faliure, void>> updatePaymentDone({
    ...
    try {
      return Right(await notificationsDataSource.updatePaymentDone(
          description: description,
          title: title,
          status: status,
          remind12: remind12,
  ...
  Future<Either<Faliure, void>> updatePaymentRemember({
    ...
    try {
      return Right(await notificationsDataSource.updatePaymentRemember(
          description: description,
          title: title,
          status: status,
          remind12: remind12,
  ...
  Future<Either<Faliure, void>> updatePaymentThanks({
    ...
    try {
      return Right(await notificationsDataSource.updatePaymentThanks(
          description: description,
          title: title,
          status: status,
          remind12: remind12,

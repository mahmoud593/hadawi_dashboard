...
class UpdateOccasionDoneUseCases{
  ...
  Future<Either<Faliure, void>> call({
    ...
    return await notificationRepo.updatePaymentDone(description: description, title: title, status: status, remind12: remind12, remind24: remind24, remind48: remind48);
  }
